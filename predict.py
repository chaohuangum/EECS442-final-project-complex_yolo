...
for file_i in [39]:
	...
	misc.imsave('predict_output/eval_bv'+test_i+'.png', rgb_map)
	...
	img = cv2.imread('predict_output/eval_bv'+test_i+'.png')
...
# 	    true_boxes.append(box)
	...
	misc.imsave('predict_output/eval_bv_bbx' + test_i + '.png', img)
	np.save("all_predicts_" + str(file_i) +".npy", all_predicts)
